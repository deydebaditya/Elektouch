...
public class AI_actual {
        ...
        static String KnowledgeBase[][][] = {
                ...
                {{"LIGHTS OFF","TURN OFF LIGHT" ,"PLEASE TURN OFF LIGHT" , "OFF LIGHT","TURN OFF THE LIGHT","TURN OFF THE LIGHTS","SWITCH OFF THE LIGHTS","PLEASE TURN OFF THE LIGHTS"},
                        {"LIGHTS OFF",
                                "LIGHTS OFF",
                                "LIGHTS OFF"}
                },
                {{"FANS OFF","TURN OFF FAN" ,"PLEASE TURN OFF FAN" , "OFF FAN","TURN OFF THE FAN","TURN OFF THE FANS","SWITCH OFF THE FANS","PLEASE TURN OFF THE FANS"},
                        {"FANS OFF",
                                "FANS OFF",
                                "FANS OFF"}
                },
                ...
                {{"TURN ON THE FAN" ,"SWITCH ON THE FAN" , "ON FAN" ,"FANS ON","FAN ON","TURN ON THE FANS" ,"SWITCH ON THE FANS","PLEASE TURN ON THE FAN"},
                        {"FANS ON",
                                "FANS ON"
                               }
                },
                {{"TURN ON THE LIGHTS " ,"SWITCH ON THE LIGHTS" , "LIGHTS ON" ,"ON LIGHT" ,"ON LIGHTS","LIGHT ON" ,"SWITCH ON THE LIGHT" ,"TURN ON THE LIGHT"},
                        {"LIGHTS ON",
                                "LIGHTS ON"
                        }
                },
    ...
    return output;
        ...
        public static String print_response()  {
            ...
            else return "it has no response";
        }
